    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto pt-10 ">
        ...
        <motion.p
          ...
          className="text-sm md:text-base font-heading font-semibold text-foreground mb-6"
        >
        ...
        <motion.p
          ...
          className="text-base md:text-lg text-secondary italic font-heading mb-5"
        >
        ...
        >
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-primary/20 border border-primary/40 text-primary font-heading font-bold text-xl md:text-2xl text-glow-blue">
            ...
            <span className="line-through opacity-50 mr-2">March 6 & 7</span>
            <span className="text-primary font-bold">March 25 & 26, 2026</span>
          </div>
          <div className="mt-3 flex flex-wrap items-center justify-center gap-4 md:gap-6 text-sm text-muted-foreground">
            <span className="flex items-center gap-2">
              <Clock size={16} className="text-primary" /> Start: March 25 -
              9:00 AM
            </span>
            <span className="flex items-center gap-2">
              <Clock size={16} className="text-secondary" /> End: March 26 -
              Evening
            </span>
          </div>
        </motion.div>
        ...
        <motion.p
          ...
          className="text-xs md:text-sm text-muted-foreground font-heading mb-4"
        >
          Registration Ends:{" "}
          <span className="text-foreground font-semibold">March 21</span> •
          Teams Announcement:{" "}
          <span className="text-foreground font-semibold">March 23</span>
        </motion.p>
        ...
        <motion.div
          ...
          className="flex justify-center gap-3 md:gap-5 mb-6"
        >
          {units.map((u) => (
            <div
              key={u.label}
